  ...
  return (
    <div className="bg-cq-milk rounded-cq-lg shadow-cq-card p-4 sm:p-6">
      <div className="flex items-center gap-2 mb-1">
        <KeyRound className="w-5 h-5 text-cq-caramel-deep" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-cq-ink-2 mb-1">
            Event code <span className="text-cq-ink-3 font-normal">— short, no spaces</span>
          </label>
          <input
            value={code}
        ...
        <div>
          <label className="block text-sm font-medium text-cq-ink-2 mb-1">
            Event password <span className="text-cq-ink-3 font-normal">— optional</span>
          </label>
          <input
            value={password}
            ...
            disabled={!loaded}
          />
          <p className="mt-1 text-xs text-cq-ink-3">
      ...
      <label className="mt-4 flex items-start gap-2 cursor-pointer">
        ...
        <span className="text-sm text-cq-ink-2">
          ...
          {require && !cleanCode && (
            <span className="block text-cq-caramel-deep font-semibold">
