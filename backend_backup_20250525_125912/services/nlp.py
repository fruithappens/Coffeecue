...
class NLPService:
    ...
    def load_coffee_database(self):
        ...
        self.coffee_types = {
            # Standard coffees
            "cappuccino": ["cap", "capp", "caps", "capaccino", "capacino", "capochino", "capuccino", "cappacino", "cappacino", "cappcino"],
            "latte": ["lat", "late", "lattee", "lattay", "lattae", "café latte", "cafe latte", "coffee latte"],
            "flat white": ["fw", "flatwhite", "flat-white", "flatty", "flattie", "flat-w", "flatw", "flt white"],
            "espresso": ["esp", "expresso", "shot", "short black", "sb", "espresso shot", "exspresso", "spro"],
            "long black": ["lb", "americano", "longblack", "long-black", "americano coffee", "long coffee"],
        ...
        # Temperature terms
        self.temperatures = {
            "extra hot": ["very hot", "really hot", "super hot", "xhot", "x-hot", "hot hot", "piping hot", "steaming", "burn", "burning", "scalding"],
            "warm": ["not too hot", "just warm", "less hot", "luke warm", "lukewarm", "mild", "medium"],
